...
const App: React.FC = () => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
          <IonTitle className="text-center text-lg">Convertidor de longitud</IonTitle>
        </IonToolbar>
      </IonHeader >
      <IonContent className="flex flex-col items-center justify-center min-h-screen bg-gray-100 ion-padding">
      <h2 className="text-2xl font-bold mt-4 mb-2 flex flex-col items-center justify-center">Ingresa las longitudes</h2>
